...
class Processor(object):
    ...
    def workflow(self,pred=False,val=False):
        ...
        for dataframe in self.datalist:
            sc_id_bytes = dataframe['scenario/id'].numpy()[0]
            sc_id = str(sc_id_bytes, encoding="utf-8")
...
if __name__ == "__main__":
    ...
    # Updated paths based on your specified directory structure
    default_ids_dir = "/raid/STrajNet/waymo_open_dataset_motion_v_1_1_0/occupancy_flow_challenge"
    default_save_dir = "/raid/STrajNet/preprocessed_data/"
    default_file_dir = "/raid/STrajNet/waymo_open_dataset_motion_v_1_1_0/tf_example"

    parser = argparse.ArgumentParser(description='Data-preprocessing')
    parser.add_argument('--ids_dir', type=str, help='ids.txt downloads from Waymos', default=default_ids_dir)
    parser.add_argument('--save_dir', type=str, help='saving directory', default=default_save_dir)
    parser.add_argument('--file_dir', type=str, help='Dataset directory', default=default_file_dir)
