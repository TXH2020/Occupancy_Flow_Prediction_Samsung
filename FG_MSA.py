...
class FGMSA(tf.keras.Model):
    ...
    def call(self, x,training=True,last_reference=None):
        ...
        print(f"offset shape: {offset.shape}, expected shape: {(B, self.n_groups, Hk, Wk, 2)}")
...
if __name__=='__main__':
    FGMSA(attn_drop=0.125, proj_drop=0.125, fg=True, q_size=(16,16), kv_size=(16,16), n_heads=8, n_head_channels=48,n_groups=8,in_dim=384,out_dim=384)